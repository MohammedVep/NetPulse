...
- Timeline: `apps/web/public/proof-pack/timeline.txt`
- PgBouncer output: `apps/web/public/proof-pack/pgbouncer.txt`
- mTLS chaos log: `apps/web/public/proof-pack/mtls-chaos.txt`
- Structured report: `apps/web/public/proof-pack/mtls-chaos-report.json`
